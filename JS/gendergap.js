// This is the fourth stacked bar chart in the housing page. 
// I referred to 'Interactive stacked bar chart using Protoviz' code from Casper Kuijjer(https://bl.ocks.org/ckuijjer/f2411940bd9047f4bfc3713a1e3bd25d) and changed the details to adjust to my data.  
...
(function () { 
    ...
    const legend = serie
      ...
      .attr('fill', '#000')
      .text(function (d) {
        var lbl = d.key.replace('_', ' '); //to remove '_' in the legend
       return lbl;
      })
